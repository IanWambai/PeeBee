...
/**
 * Created by Wednesday on 10/14/2015.
 */
public class ImageSelector {
     ...
     */
    public void onCropImageClick(View view, CropImageView mCropImageView) {
    ...
    public static Intent getPickImageChooserIntent(Activity activity) {
        ...
        Intent chooserIntent = Intent.createChooser(mainIntent, "Select an image from");
