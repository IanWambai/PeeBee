package com.toe.firstcustoma.activities;
...
import com.toe.firstcustoma.adapters.StoresRecyclerViewAdapter;
import com.toe.firstcustoma.classes.RecyclerItemClickListener;
import com.toe.firstcustoma.constructors.StoreListItem;
import com.toe.firstcustoma.utils.FirebaseUtils;
import com.toe.firstcustoma.utils.Utils;
...
//                    }
    ...
    private void populatePlains(final ArrayList<StoreListItem> plains) {
        if (plains.size() > 0) {
            ...
            plainsRecyclerView.setAdapter(new SlideInBottomAnimationAdapter(plainsAdapter));
